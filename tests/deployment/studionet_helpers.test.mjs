...
test("lifecycle selection resumes from canonical state without replaying writes", () => {
  ...
  assert.equal(selectNextLifecycleAction({ rootStatus: "ACTIVE", objectiveExpansionProved: true, validStatus: "ACTIVE", expansionStatus: "DENIED", ambiguousStatus: "AMBIGUOUS", ambiguousReviewRetryRejected: true, ambiguousCopyRejected: true, revisedStatus: null }), "PROPOSE_REVISED");
  assert.equal(selectNextLifecycleAction({ rootStatus: "ACTIVE", objectiveExpansionProved: true, validStatus: "ACTIVE", expansionStatus: "DENIED", ambiguousStatus: "AMBIGUOUS", ambiguousReviewRetryRejected: true, ambiguousCopyRejected: true, revisedStatus: "PROPOSED" }), "REVIEW_REVISED");
  assert.equal(selectNextLifecycleAction({ rootStatus: "ACTIVE", objectiveExpansionProved: true, validStatus: "ACTIVE", expansionStatus: "DENIED", ambiguousStatus: "AMBIGUOUS", ambiguousReviewRetryRejected: true, ambiguousCopyRejected: true, revisedStatus: "ACTIVE", accessBefore: null }), "CHECK_ACCESS_BEFORE");
  assert.equal(selectNextLifecycleAction({ rootStatus: "ACTIVE", objectiveExpansionProved: true, validStatus: "ACTIVE", expansionStatus: "DENIED", ambiguousStatus: "AMBIGUOUS", ambiguousReviewRetryRejected: true, ambiguousCopyRejected: true, revisedStatus: "ACTIVE", accessBefore: "ALLOWED" }), "REVOKE_ROOT");
  assert.equal(selectNextLifecycleAction({ rootStatus: "REVOKED", objectiveExpansionProved: true, validStatus: "ACTIVE", expansionStatus: "DENIED", ambiguousStatus: "AMBIGUOUS", ambiguousReviewRetryRejected: true, ambiguousCopyRejected: true, revisedStatus: "ACTIVE", accessBefore: "ALLOWED", accessAfter: null }), "CHECK_ACCESS_AFTER");
  assert.equal(selectNextLifecycleAction({ rootStatus: "REVOKED", objectiveExpansionProved: true, validStatus: "ACTIVE", expansionStatus: "DENIED", ambiguousStatus: "AMBIGUOUS", ambiguousReviewRetryRejected: true, ambiguousCopyRejected: true, revisedStatus: "ACTIVE", accessBefore: "ALLOWED", accessAfter: "ANCESTOR_INACTIVE" }), "COMPLETE");
